    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$', 32), 'Name can only contain letters, digits or thefollowing characters: @/./+/-/_', 'invalid')], verbose_name='Nome de Usuário')),
